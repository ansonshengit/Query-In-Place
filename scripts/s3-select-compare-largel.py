...
#Smaller file is about 500MB size
key = 'sample-data/airport-code-large.csv'
...
print("This query will cost about $0.01 without S3 Select, and about $0.001 with S3 Select.")
